...
/******/ 	}
/******/ 	var parentHotUpdateCallback = window["webpackHotUpdateXbsjEarthUI"];
...
/******/ 	var hotCurrentHash = "89b622ec45e378936f73"; // eslint-disable-line no-unused-vars
...
/******/ 	return hotCreateRequire(2010)(__webpack_require__.s = 2010);
/******/ })
/************************************************************************/
/******/ ({
...
function create(earthDom, options) {
    return new _promise2.default(function (resolve, reject) {
        ...
        if (typeof XbsjEarthUI.ready === 'undefined') {
            ...
            var xbsjUri = getScriptBaseUrl('xbsj');
            var xbsjEarthUIUri = getScriptBaseUrl('xbsj') + 'XbsjEarthUI.js';
            var xbsjEarthUri = (window.xbsjEarthDir || getScriptBaseUrl('xbsj')) + '../XbsjEarth/XbsjEarth.js';

            var pluginUris = [xbsjUri + '../XbsjEarth-Plugins/plottingSymbol/plottingSymbol.js', xbsjUri + '../XbsjEarth-Plugins/customPrimitive/customPrimitive.js', xbsjUri + '../XbsjEarth-Plugins/customPrimitiveImage/customPrimitiveImage.js', xbsjUri + '../XbsjEarth-Plugins/plottingSymbol2/plottingSymbol2.js'];

            _promise2.default.all([loadJS(xbsjEarthUIUri), loadJS(xbsjEarthUri)]).then(function () {
                return XE.ready().then(function () {
                    var loadPlugins = pluginUris.map(function (e) {
                        return loadJS(e);
                    });
                    return _promise2.default.all(loadPlugins);
                }).then(function () {

                    //创建earthUI 
                    var earthUI = new XbsjEarthUI.MainUI(earthDom);
                    //隐藏等待图标
            ...
            //创建earthUI 
            var earthUI = new XbsjEarthUI.MainUI(earthDomID);
            resolve(earthUI);
        }
    });
}
...
__webpack_require__(52)(IteratorPrototype, __webpack_require__(32)('iterator'), function () { return this; });
